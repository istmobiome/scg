...
download_link(
  link = "https://github.com/istmobiome/scg/tree/main/files/MAG",
...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------|
| [00_MAGS.txt](files/MAG/00_MAGS.txt)                                                   | list of all MAGs in the collection.                         |
...
tmp_download <- read_delim("files/MAG/01_hmm_hits_info.txt", delim = "\t")
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MAG", pattern = "02_", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "02_HMM_SCG_INFO",
  button_label = "SCG info for HMM profiles",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
tmp_download <- read_delim("files/MAG/03_GTDB_Taxonomy.txt", delim = "\t")
download_this(tmp_download,
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
tmp_download <- read_delim("files/MAG/04_SCG_master_list.txt", delim = "\t")
download_this(tmp_download,
    output_name = "04_SCG_master_list",
    output_extension = ".csv",
    button_label = "csv file of all HMM profile genes",
    button_type = "default",
    csv2 = FALSE,
    has_icon = TRUE,
    icon = "fa fa-save")
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
tmp_download <- read_delim("files/MAG/05_MAG-COMPLETENESS.txt", delim = "\t")
download_this(tmp_download,
    output_name = "05_MAG-COMPLETENESS",
    output_extension = ".csv",
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
tmp_download <- read_delim("files/MAG/05_MAG-TAXONOMY.txt", delim = "\t")
download_this(tmp_download,
    output_name = "05_MAG-TAXONOMY",
    output_extension = ".csv",
    button_label = "csv file of MAG concensus Taxonomy",
    button_type = "default",
    csv2 = FALSE,
    has_icon = TRUE,
    icon = "fa fa-save")
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
tmp_download <- read_delim("files/MAG/05_MAG-TAXONOMY-PER-GENOME-SCG.txt", delim = "\t")
download_this(tmp_download,
    output_name = "05_MAG-TAXONOMY-PER-GENOME-SCG",
    output_extension = ".csv",
    button_label = "csv file of Taxonomy for all MAG SCG ",
    button_type = "default",
    csv2 = FALSE,
    has_icon = TRUE,
    icon = "fa fa-save")
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
tmp_download <- read_delim("files/MAG/06_MAG_TAXONOMY_and_COMPLETENESS.txt", delim = "\t")
download_this(tmp_download,
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MAG", pattern = "07_", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "07_HITS-ACROSS-MAGs",
  button_label = "Distribution of SCG hits across MAGs",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MAG", pattern = "-sequences.fa", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "08_MAGS-SCG-sequences",
  button_label = "fasta files of SCG hits",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MAG", pattern = "09_MAGS-", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "09_MAGS-SCG-details",
  button_label = "detailed data for all SCG hits",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, eval=TRUE, echo=FALSE}
download_link(
  link = "https://github.com/istmobiome/scg/tree/main/files/MG",
  button_label = "Download the full data pack here",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MG", pattern = "-sequences.fa", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "01_WA-sequences",
  button_label = "fasta files of SCG hits",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MG", pattern = "02_WA-", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "02_WA-SCG-HITS",
  button_label = "details for all SCG hits against HMM profiles",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MG", pattern = "03_WA-", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "03_WA-GENE-HIT-IDS",
  button_label = "Lists of gene IDs",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MG", pattern = "04_WA-", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "04_WA-COVERAGE-DETECTION",
  button_label = "Raw coverage & detection data",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
path_files <- list.files(path = "files/MG", pattern = "05_WA-", 
                         all.files = TRUE, full.names = TRUE, 
                         recursive = FALSE, ignore.case = TRUE)
download_file(
  path = path_files,
  output_name = "05_WA-GENE-COVERAGE-DETECTION",
  button_label = "Final coverage & detection data",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r, echo=FALSE, eval=TRUE, layout="l-body"}
tmp_download <- read_delim("files/MG/07_SCG_TAXONOMY.txt", delim = "\t")
download_this(tmp_download,
    output_name = "07_SCG_TAXONOMY",
    output_extension = ".csv",
    button_label = "csv file of taxonomy for all SCG ",
    button_type = "default",
    csv2 = FALSE,
    has_icon = TRUE,
    icon = "fa fa-save")
